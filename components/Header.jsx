            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-[10px]">
                    ...
                    <div className="leading-[20px]">
                        <h2 className="text-xl text-smallTextColor font-[700]">MoonJae</h2>
                ...
                <div className="flex items-center gap-4">
                    <button className='flex items-center gap-2 text-smalltextColor font-[600] boorder border-solid border-smalltextColor py-2 px-4 rounded-[8px] max-h-[40px] hover:bg-smalltextColor hover:text-white hover:font-[500] ease-in duration-300'>
